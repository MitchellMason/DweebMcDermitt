...
public static class LaserUtils{
	...
	/*public static LaserHitInfo toLaserHitInfo(RaycastHit r, LaserEmitter laseremit){
		LaserHitInfo l = new LaserHitInfo ();
		l.hitPoint = r.point;
		l.hitSurfaceNormal = r.normal;//new Vector3(r.normal.x,-r.normal.y,r.normal.z);//r.normal;
		l.laserEmitter = laseremit;
		l.remainingDistance = Vector3.Distance (l.laserEmitter.transform.position, r.collider.transform.position);
		return l;
	}*/
}
