...
namespace ConstructiveSolidGeometry
{
    public class CSGUtils
    {
        ...
        /// <returns></returns>
        public static Polygon createPolygon(Vector3[] points, System.Object shared)
        {
            if (points.Length < 2)
            {
                return null;
        ...
        /// <returns></returns>
        public static List<Polygon> extrudePolygon(Polygon polygon, float distance, Vector3 normal)
        {
